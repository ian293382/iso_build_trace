...
mkdir ../{tool,output}; chown ian ../{tool,output}
...
case $REPLY in
    1)
        cp -p ./../iso_build/ref/Boot_Legacy/grub.cfg "./../${UNPACK_OUTPUT_FILENAME}/boot/grub/grub.cfg"
        cp -p ./../iso_build/ref/Boot_Legacy/txt.cfg "./../${UNPACK_OUTPUT_FILENAME}/isolinux/txt.cfg"
        break
    ;;
    2)
        cp -p ./../iso_build/ref/Boot_UEFI/grub.cfg "./../${UNPACK_OUTPUT_FILENAME}/boot/grub/grub.cfg"
        cp -p ./../iso_build/ref/Boot_UEFI/txt.cfg "./../${UNPACK_OUTPUT_FILENAME}/isolinux/txt.cfg"
        break
    ;;
    3)
        cp -p ./../iso_build/ref/Boot_UEFI_Test_Phase/grub.cfg "./../${UNPACK_OUTPUT_FILENAME}/boot/grub/grub.cfg"
        cp -p ./../iso_build/ref/Boot_UEFI_Test_Phase/txt.cfg "./../${UNPACK_OUTPUT_FILENAME}/isolinux/txt.cfg"
        break
    ;;
    *) echo "please choose 1-3"
    ;;
...
cp -rp "./../iso_build/ref/${AUTOINSTALL_FILENAME}" "./../${UNPACK_OUTPUT_FILENAME}"
